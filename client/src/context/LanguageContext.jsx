...
const translations = {
  en: {
    ...
    "add.subtitle": "List your property in a few easy steps.",
    "add.step1": "Basic Information",
    "add.step2": "Price & Location",
    "add.step3": "Property Details",
    "add.step4": "Photos",
    "add.dropPhotos": "Click to choose photos",
    "add.coverHint": "The first photo becomes the cover · up to 5 photos",
    ...
    "dash.receivedRequests": "Viewing Requests",
    "dash.paymentsReceived": "Payments Received",
    "dash.noPaymentsYet": "No payments received yet.",
    ...
    "prop.copyLink": "Copy listing link",
    "prop.delete": "Delete property",
    "prop.deleteConfirm": "Delete this property? This cannot be undone.",
    "prop.markUnavailable": "Mark unavailable",
    "prop.markAvailable": "Mark available",
    "prop.share": "Share",
    "prop.bookings": "bookings",
    "prop.earned": "earned",
    "prop.duplicate": "Duplicate",
    "add.pricePeriod": "Price period",
    "price.month": "/month",
    "price.week": "/week",
    "price.day": "/day",
    "price.year": "/year",
    ...
    "admin.statProperties": "Total Properties",
    "admin.statBookings": "Total Bookings",
    ...
    "admin.noProperties": "No properties found.",
    ...
    "admin.deletePaymentConfirm": "Delete this payment?",
    "admin.deleteReviewConfirm": "Delete this review?",
    ...
    "payments.rejectTitle": "Reject payment",
    "payments.rejectPh": "Explain why this payment is rejected (required)",
    ...
    "auth.heroTitle": "Find your next home in Ethiopia",
    "auth.heroTag": "Browse verified listings, book viewings, and pay securely — all in one place.",
    "auth.point1": "Verified landlords & listings",
    "auth.point2": "Easy viewing requests",
    "auth.point3": "Secure proof-of-payment",
  ...
  am: {
    ...
    "add.subtitle": "ንብረትዎን በቀላል ደረጃዎች ይዘርዝሩ።",
    "add.step1": "መሰረታዊ መረጃ",
    "add.step2": "ዋጋ እና አድራሻ",
    "add.step3": "የንብረት ዝርዝሮች",
    "add.step4": "ፎቶዎች",
    "add.dropPhotos": "ፎቶዎችን ለመምረጥ ይጫኑ",
    "add.coverHint": "የመጀመሪያው ፎቶ ሽፋን ይሆናል · እስከ 5 ፎቶዎች",
    "edit.title": "ቤት አስተካክል",
    "edit.button": "ለውጦችን አስቀምጥ",
    "edit.removePhoto": "ፎቶ አስወግድ",
    ...
    "dash.receivedRequests": "የመመልከቻ ጥያዎች",
    "dash.paymentsReceived": "የተቀበሉ ክፍያዎች",
    "dash.noPaymentsYet": "እስካሁን ምንም ክፍያ አልተቀበሉም።",
    ...
    "prop.furnished": "በእቃዎች የተደራጀ",
    "prop.unavailable": "አይገኝም",
    "prop.copyLink": "የማስታወቂያ አገናኝ ቅዳ",
    "prop.delete": "ንብረቱን አጥፋ",
    "prop.deleteConfirm": "ይህን ንብረት ማጥፋት ይፈልጋሉ?",
    "prop.markUnavailable": "አይገኝም ምልክት አድርግ",
    "prop.markAvailable": "ይገኛል ምልክት አድርግ",
    "prop.share": "አጋራ",
    "prop.bookings": "ማስያዣዎች",
    "prop.earned": "ገቢ",
    "prop.duplicate": "ቅጂ ፍጠር",
    "add.pricePeriod": "የዋጋ ጊዜ",
    "price.month": "/ወር",
    "price.week": "/ሳምንት",
    "price.day": "/ቀን",
    "price.year": "/ዓመት",
    ...
    "admin.controlCenter": "የአስተዳዳሪ መቆጣጠሪያ ማዕከል",
    "admin.tabOverview": "አጠቃላይ እይታ",
    "admin.tabBookings": "ቦታ ማስያዣዎች",
    "admin.statUsers": "ጠቅላላ ተጠቃሚዎች",
    "admin.statProperties": "ጠቅላላ ንብረቶች",
    "admin.statBookings": "ጠቅላላ ቦታ ማስያዣዎች",
    "admin.statReviews": "ግምገማዎች",
    "admin.statReports": "ሪፖርቶች",
    "admin.approved": "ጸድቋል",
    "admin.rejected": "ተቀባይነት አላገኘም",
    "admin.cancelled": "ተሰርዟል",
    "admin.pendingProperties": "በመጠባበቅ ላይ ያሉ ንብረቶች",
    "admin.pendingBookings": "በመጠባበቅ ላይ ያሉ ቦታ ማስያዣዎች",
    "admin.pendingReports": "በመጠባበቅ ላይ ያሉ ሪፖርቶች",
    "admin.noUsers": "ምንም ተጠቃሚዎች አልተገኙም።",
    "admin.noProperties": "ምንም ንብረቶች አልተገኙም።",
    "admin.noBookings": "ምንም ቦታ ማስያዣዎች አልተገኙም።",
    "admin.deleteBookingConfirm": "ይህን ቦታ ማስያዣ ለመሰረዝ እርግጠኛ ነዎት?",
    "admin.reject": "ውድቅ አድርግ",
    "admin.cancel": "ሰርዝ",
    "admin.tenantCol": "ተከራይ",
    "admin.dateCol": "ቀን",
    "admin.method": "ዘ",
    "admin.shot": "ማስረጃ",
    "admin.rating": "ደጃ",
    "admin.comment": "አስተያየት",
    "admin.successful": "ተሳክቷል",
    "admin.refunded": "ተመልሷል",
    "admin.noPayments": "እስካሁን ምንም ክፍያዎች የሉም።",
    "admin.noReviews": "እስካሁን ምንም ግምገማዎች የሉም።",
    "admin.deletePaymentConfirm": "ይህን ክፍያ ለመሰረዝ እርግኛ ዎት?",
    "admin.deleteReviewConfirm": "ይህን ግምገማ ለመሰረዝ እርግኛ ዎት?",
    ...
    "auth.heroTitle": "ቀይ ቤትዎን በኢትያ ያኙ",
    "auth.heroTag": "የተረጋገጡ ማስታወቂያዎችን ይመልከቱ፣ ቀጠሮ ስይዙ በአስተማማኝ ሁኔታ ይክፈሉ",
    "auth.point1": "የተረጋጡ ባለቶች እና ቶች",
    "auth.point2": "ቀላል የመመልከቻ ጥያቄች",
    "auth.point3": "ደንነቱ የተጠበቀ ክፍያ",
    "auth.showPassword": "የይለፍ ቃል አሳይ",
    "auth.hidePassword": "የይለፍ ል ደቅ",
    ...
    "payments.cancel": "ሰርዝ",
    "payments.totalPaid": "ጠቅላላ የተከፈለ",
    "payments.ref": "ማጣቀሻ",
    "payments.viewProof": "ማስረጃን ተመልከት",
    "payments.rejectTitle": "ክፍያውን ውድቅ አድርግ",
    "payments.rejectPh": "ክፍያውድ ውድቅ የተደረገበትን ምንንያት ያብራሩ (አስፈላጊ)",
